...
| ------------------------------ | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| AT Continuity                  | `lib/at-continuity/**` (Wave 1 scaffold in #382; writers flag-gated; not on main yet) | ParticipantProfile, ConsentRecord, AuditEvent, Care/Transport/Jobs links, Organisation / provider refs    | Clinical suitability SoT; second participant identity; emergency-response claims                              |
