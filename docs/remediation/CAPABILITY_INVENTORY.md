...
| ndis.at_continuity               | Assistive Technology Continuity   | programmes     | scaffolded         | false              | verified              | Wave 1 scaffold + `at_*` tables; writers flag-gated; not production-supported          |
